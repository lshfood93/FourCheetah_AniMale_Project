...
<%-- JSTL: core/functions/fmt
     ...
     - functions(fn): 문자열 처리 등
     - fmt: 숫자/날짜 포맷(추후 확장 가능)
--%>
...
<%-- ✅✅ CHANGED: 로그인 여부 먼저 체크 (관리자 페이지 공통 정책) --%>
<c:if test="${empty sessionScope.memberId}">
  <c:redirect url="${ctx}/login" />
</c:if>

<%-- ✅✅ CHANGED: 접근 제어(관리자만)
     - role 대소문자 섞여도 안전하도록 toUpperCase로 통일
--%>
<c:if test="${empty sessionScope.memberRole or fn:toUpperCase(sessionScope.memberRole) ne 'ADMIN'}">
...
<body class="admin-dashboard">
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical"
    ...
    <div class="body-wrapper">
      ...
      <%-- ✅✅ CHANGED: 플로팅 헤더 include 위치를 body-wrapper 안으로 통일 --%>
