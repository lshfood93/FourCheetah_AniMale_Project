...
<%-- ✅ CHANGED: 출력 전에 ctx / 내부 URL(c:url) 변수들을 먼저 세팅 --%>
<c:set var="ctx" value="${pageContext.request.contextPath}" />

<%-- ✅ CHANGED: 컨트롤러 매핑(내부 이동/폼/AJAX)은 c:url로 통일 --%>
  ...
  <section class="spad">
    <div class="container">
      ...
      <div class="reset-wrap">
        <%-- ✅ CHANGED: form action도 c:url로 통일 --%>
...
$(function () {
  ...
  /* =========================================================
     ✅ CHANGED: ctx 문자열 조합 대신, JSP에서 만든 c:url을 그대로 사용
     - 컨텍스트(/animale) 포함된 완전한 내부 URL이 들어옴
     ========================================================= */
  ...
  $("#memberNameCheckBtn").on("click", function () {
    ...
    $.ajax({
      url: URL_MEMBER_NAME_CHECK,   // ✅ CHANGED
      type: "POST",
      dataType: "json",
  ...
  $("#memberNicknameCheckBtn").on("click", function () {
    ...
    $.ajax({
      url: URL_MEMBER_NICK_CHECK,   // ✅ CHANGED
      type: "POST",
      dataType: "json",
  ...
  $("#emailCheckBtn").on("click", function () {
    ...
    $.ajax({
      url: URL_MEMBER_EMAIL_CHECK,  // ✅ CHANGED
      type: "POST",
      dataType: "json",
  ...
  $("#sendEmailAuthBtn").on("click", function (e) {
    ...
    $.ajax({
      url: URL_SEND_EMAIL_CODE,  // ✅ CHANGED
      type: "POST",
      dataType: "json",
  ...
  $("#verifyEmailAuthBtn").on("click", function () {
    ...
    $.ajax({
      url: URL_VERIFY_EMAIL_CODE,  // ✅ CHANGED
      type: "POST",
      dataType: "json",
