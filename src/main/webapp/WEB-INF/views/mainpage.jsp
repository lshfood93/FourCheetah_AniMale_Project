...
<%-- ✅ CHANGED: 매핑 링크(파라미터 없는 링크)도 c:url로 통일하면 컨텍스트 자동 + 일관성 확보 --%>
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="hero__text">
                    ...
                    <%-- ✅ CHANGED: newsList도 c:url 사용(컨텍스트 자동) --%>
          ...
          <c:otherwise>
            <c:forEach var="n" items="${mainBannerNewsList}" varStatus="st">
              <c:if test="${st.count <= 3}">
                ...
                <%-- ✅ CHANGED: 파라미터 링크는 c:url로 생성 (컨텍스트 자동 + 인코딩 안전) --%>
          ...
          <c:otherwise>
            <c:forEach var="a" items="${mainAnimeList}" varStatus="st">
              <c:if test="${st.count <= 12}">
                ...
                <%-- ✅ CHANGED: 애니 상세 링크도 c:url로 1번만 만들고 재사용 --%>
