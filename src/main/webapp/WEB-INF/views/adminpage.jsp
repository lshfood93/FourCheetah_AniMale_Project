...
<c:set var="urlNewsManage" value="${ctx}/news/list"/>
<c:set var="urlAnimeListManage" value="${ctx}/anime/list"/>
<c:set var="urlMyPosts" value="${ctx}/mypost" />
<c:set var="urlChangePassword" value="${ctx}/changepassword"/>
