...
<body>
   ...
   $(function() {
      ...
      /* =========================
         ✅ ADMIN 무료 꾸미기 (레인보우) - 최종
         - 클릭 즉시 미리보기
         - hidden 값 변경 (컨트롤러 붙이면 저장/로드에 그대로 사용)
         ========================= */
      (function(){
        const $btnNick = $("#btnNickDeco");
        const $btnProf = $("#btnProfileDeco");

        const $nickText = $("#nicknameText"); // ✅ 표시용
        const $nickPill = $("#nicknamePill"); // 테두리
        const $profile  = $("#profileWrap");  // 테두리
