						...
						<div class="row">
							...
							<div class="col-lg-9">
								<div class="anime__details__text">
									...
									<form class="admin-form" action="${ctx}/animeEdit"
										method="post" enctype="multipart/form-data" style="margin-top: 18px;">
										...
										<div class="row">
											...
											<div class="col-lg-12">
												<div class="form-group" style="margin-bottom: 16px;">
													...
													<input type="text" class="form-control" name="animeTitle"
											...
											<div class="col-lg-12">
												<div class="form-group" style="margin-bottom: 16px;">
													...
													<input type="text" class="form-control"
														name="originalTitle" id="original_title" maxlength="200"
											...
											<div class="col-lg-6 col-md-6">
												<div class="form-group" style="margin-bottom: 16px;">
													...
													<input type="number" class="form-control" name="animeYear"
											...
											<div class="col-lg-6 col-md-6">
												<div class="form-group" style="margin-bottom: 16px;">
													...
													<select class="form-control" name="animeQuarter"
