...
<%-- ✅ ctx/cp 통일: 스크립틀릿(request.getContextPath) 제거 --%>
...
<link rel="icon" type="image/png" href="${cp}/favicon.png">
...
.ad-btn:focus-visible{ outline:none; box-shadow:0 0 0 3px rgba(140,200,255,0.35); }
        ...
        <div class="row anime-detail-row">
          ...
          <div class="col-lg-4">
            <div class="anime-thumb">
              ...
              <%-- ✅ 썸네일 URL 정규화(상대/절대/ctx 포함 케이스 흡수) --%>
              ...
              <%-- ✅ 제목/alt XSS 방어(c:out) --%>
              <img src="${thumbSrc}" alt="<c:out value='${animeData.animeTitle}'/>">
          ...
          <div class="col-lg-8">
            <div class="anime-info">
              ...
              <div class="anime-title">
                <c:out value="${animeData.animeTitle}" />
              </div>

              <div class="meta-chips">
                <span class="meta-chip">
                  <i class="fa fa-calendar"></i>
                  방영년도 <c:out value="${animeData.animeYear}" />
                </span>

                <span class="meta-chip">
                  <i class="fa fa-tag"></i>
                  방영분기 <c:out value="${animeData.animeQuarter}" />
                </span>
              </div>

              <%-- ✅ 시놉시스도 기본은 escape(보안). HTML 렌더가 필요하면 escapeXml="false"로 바꾸면 됨 --%>
              <div class="anime-synopsis">
                <c:out value="${animeData.animeStory}" />
              </div>
              ...
              <div class="action-wrap">
                ...
                <c:if test="${sessionScope.memberRole eq 'ADMIN'}">
                  ...
                  <%-- ✅ 삭제: a onclick 대신 form onsubmit confirm으로 안정화(closest 미사용) --%>
                  <form action="${cp}/animeDelete"
                        method="post"
