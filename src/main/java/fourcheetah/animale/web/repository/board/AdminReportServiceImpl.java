...
public class AdminReportServiceImpl implements AdminReportService {
    ...
    /**
     * 신고 상세 조회 - ✅ FIXED: selectAll 대신 selectOneByBoardId 사용
     */
    @Override
    public BoardReportDTO selectReportDetail(int boardId) {
        ...
        try {
            // ✅ FIXED: 페이징 없이 boardId로 직접 단건 조회
            BoardReportDTO result = boardReportDAO.selectOneByBoardId(boardId);
