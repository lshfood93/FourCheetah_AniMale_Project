...
public class BoardController {
	...
	public String boardDetail(
		...
		if (boardData == null) {
			...
			return message(model, "존재하지 않는 게시글입니다.", "/mainPage");
		}
	...
	public String boardEditPage(
		...
		// (추가) 수정 화면 진입 시에도 본문 sanitize (레거시 데이터 방어)
		boardData.setBoardContent(
